...
public class ExcelUtil {
    ...
    //in excel columnnnumber starts from 0 & rownumber starts from 1
	...
	public String getCellData(String sheetName, String colName, int rowNum) {
		try {
			...
			// if(cell.getCellType()==ExcelUtil.CELL_TYPE_STRING)
			// return cell.getStringCellValue();
	...
	//
	// XSSFHyperlink link = createHelper.createHyperlink(ExcelUtil.LINK_FILE);
	// link.setAddress(url);
